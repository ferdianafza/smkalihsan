...
class ArtikelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artikel" do
    assert_difference('Artikel.count') do
      post artikels_url, params: { artikel: { judul: @artikel.judul, konten: @artikel.konten } }
    end
  ...
  test "should update artikel" do
    patch artikel_url(@artikel), params: { artikel: { judul: @artikel.judul, konten: @artikel.konten } }
